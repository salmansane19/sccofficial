...
def balik():
    ...
    if f == "y":
       os.system("python scccall.py")
    elif f == "t":
         sys.exit("\033[1;91mexit\033[1;97m")
os.system("clear")
print ("\tSPAM CALL V4.0")
print ("      Coded: \033[1;96mFahmiApz\033[1;97m")
print ("\033[1;97m*     Github:\033[1;92m github.com/salmansane19\033[1;97m      *")
print()
print ("\033[90m>\033[1;97m CONTOH: \033[1;92m+252617×××××××××")
no = input("\033[90m> \033[1;97mMIDKAA WACEYSID: \033[1;92m")
